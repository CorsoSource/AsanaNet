...
{
    /// <summary>
    /// PortfolioResponseAllOfCurrentStatusUpdate
    /// </summary>
    [DataContract(Name = "PortfolioResponse_allOf_current_status_update")]
    public partial class PortfolioResponseAllOfCurrentStatusUpdate : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioResponseAllOfCurrentStatusUpdate" /> class.
        /// </summary>
        /// <param name="title">The title of the status update..</param>
        public PortfolioResponseAllOfCurrentStatusUpdate(string title = default(string))
        {
            this.Title = title;
        }
