...
namespace AsanaNet.Model
{
    ...
    /// GoalUpdateRequest
    /// </summary>
    [DataContract(Name = "GoalUpdateRequest")]
    public partial class GoalUpdateRequest : IValidatableObject
    {
        ...
        public GoalUpdateRequest(string name = default(string), string htmlNotes = default(string), string notes = default(string), string dueOn = default(string), string startOn = default(string), bool isWorkspaceLevel = default(bool), bool liked = default(bool), string team = default(string), string workspace = default(string), string timePeriod = default(string), string owner = default(string), string status = default(string))
        {
            this.Name = name;
