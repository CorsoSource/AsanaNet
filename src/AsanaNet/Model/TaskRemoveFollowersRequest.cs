...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskRemoveFollowersRequest")]
    public partial class TaskRemoveFollowersRequest : IValidatableObject
    {
        ...
        public TaskRemoveFollowersRequest(List<string> followers = default(List<string>))
        {
            ...
            if (followers == null)
            {
                throw new ArgumentNullException("followers is a required property for TaskRemoveFollowersRequest and cannot be null");
            }
