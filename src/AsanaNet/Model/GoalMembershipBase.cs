...
namespace AsanaNet.Model
{
    ...
    /// GoalMembershipBase
    /// </summary>
    [DataContract(Name = "GoalMembershipBase")]
    public partial class GoalMembershipBase : IValidatableObject
    {
        ...
        public GoalMembershipBase(string resourceType = default(string), MemberCompact member = default(MemberCompact), GoalMembershipBaseAllOfParent parent = default(GoalMembershipBaseAllOfParent), RoleEnum? role = default(RoleEnum?), GoalMembershipBaseAllOfGoal goal = default(GoalMembershipBaseAllOfGoal))
        {
