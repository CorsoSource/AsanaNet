...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GoalResponse_allOf_time_period")]
    public partial class GoalResponseAllOfTimePeriod : IValidatableObject
    {
        ...
        public GoalResponseAllOfTimePeriod(string endOn = default(string), string startOn = default(string), PeriodEnum? period = default(PeriodEnum?), string displayName = default(string))
        {
            this.EndOn = endOn;
