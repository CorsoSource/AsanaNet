...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StoryResponse_allOf_new_date_value")]
    public partial class StoryResponseAllOfNewDateValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoryResponseAllOfNewDateValue" /> class.
        /// </summary>
        ...
        public StoryResponseAllOfNewDateValue(DateTime? startOn = default(DateTime?), DateTime? dueAt = default(DateTime?), DateTime dueOn = default(DateTime))
        {
