...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectTemplateResponse")]
    public partial class ProjectTemplateResponse : IValidatableObject
    {
        ...
        public ProjectTemplateResponse(string name = default(string), string description = default(string), string htmlDescription = default(string), bool varPublic = default(bool), ProjectTemplateBaseAllOfOwner owner = default(ProjectTemplateBaseAllOfOwner), TeamCompact team = default(TeamCompact), ColorEnum? color = default(ColorEnum?), List<TemplateRole> requestedRoles = default(List<TemplateRole>))
        {
            this.Name = name;
