...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StoryResponse_allOf_target")]
    public partial class StoryResponseAllOfTarget : IValidatableObject
    {
        ...
        public StoryResponseAllOfTarget(string name = default(string), ResourceSubtypeEnum? resourceSubtype = default(ResourceSubtypeEnum?), TaskCompactAllOfCreatedBy createdBy = default(TaskCompactAllOfCreatedBy))
        {
            this.Name = name;
