...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskRemoveProjectRequest")]
    public partial class TaskRemoveProjectRequest : IValidatableObject
    {
        ...
        public TaskRemoveProjectRequest(string project = default(string))
        {
            ...
            if (project == null)
            {
                throw new ArgumentNullException("project is a required property for TaskRemoveProjectRequest and cannot be null");
            }
