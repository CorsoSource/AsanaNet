...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomFieldCompact_allOf_enum_value")]
    public partial class CustomFieldCompactAllOfEnumValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomFieldCompactAllOfEnumValue" /> class.
        /// </summary>
        ...
        public CustomFieldCompactAllOfEnumValue(string name = default(string), bool enabled = default(bool), string color = default(string))
        {
            this.Name = name;
