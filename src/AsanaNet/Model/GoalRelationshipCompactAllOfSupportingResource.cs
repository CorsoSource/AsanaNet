...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GoalRelationshipCompact_allOf_supporting_resource")]
    public partial class GoalRelationshipCompactAllOfSupportingResource : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GoalRelationshipCompactAllOfSupportingResource" /> class.
        /// </summary>
        ...
        public GoalRelationshipCompactAllOfSupportingResource(string name = default(string))
        {
            this.Name = name;
        }
