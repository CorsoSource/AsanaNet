...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchRequestAction")]
    public partial class BatchRequestAction : IValidatableObject
    {
        ...
        public BatchRequestAction(string relativePath = default(string), MethodEnum method = default(MethodEnum), Object data = default(Object), BatchRequestActionOptions options = default(BatchRequestActionOptions))
        {
            ...
            {
                throw new ArgumentNullException("relativePath is a required property for BatchRequestAction and cannot be null");
            }
        ...
        [DataMember(Name = "relative_path", IsRequired = true, EmitDefaultValue = true)]
