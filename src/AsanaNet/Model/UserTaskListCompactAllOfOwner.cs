...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserTaskListCompact_allOf_owner")]
    public partial class UserTaskListCompactAllOfOwner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserTaskListCompactAllOfOwner" /> class.
        /// </summary>
        /// <param name="name">*Read-only except when same user as requester*. The user’s name..</param>
        public UserTaskListCompactAllOfOwner(string name = default(string))
        {
            this.Name = name;
        }
