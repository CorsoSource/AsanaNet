...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GoalRelationshipBase_allOf_supported_goal")]
    public partial class GoalRelationshipBaseAllOfSupportedGoal : IValidatableObject
    {
        ...
        public GoalRelationshipBaseAllOfSupportedGoal(string name = default(string), GoalCompactAllOfOwner owner = default(GoalCompactAllOfOwner))
        {
            this.Name = name;
            this.Owner = owner;
        }
