...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TagCreateTagForWorkspaceRequest")]
    public partial class TagCreateTagForWorkspaceRequest : IValidatableObject
    {
        ...
        public TagCreateTagForWorkspaceRequest(string name = default(string), ColorEnum? color = default(ColorEnum?), string notes = default(string), List<string> followers = default(List<string>))
        {
            this.Name = name;
            this.Color = color;
            this.Notes = notes;
