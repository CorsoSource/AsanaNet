...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RemoveFollowersRequest")]
    public partial class RemoveFollowersRequest : IValidatableObject
    {
        ...
        public RemoveFollowersRequest(string followers = default(string))
        {
            ...
            if (followers == null)
            {
                throw new ArgumentNullException("followers is a required property for RemoveFollowersRequest and cannot be null");
            }
