...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GoalRelationshipBase")]
    public partial class GoalRelationshipBase : IValidatableObject
    {
        ...
        public GoalRelationshipBase(GoalRelationshipCompactAllOfSupportingResource supportingResource = default(GoalRelationshipCompactAllOfSupportingResource), decimal contributionWeight = default(decimal), GoalRelationshipBaseAllOfSupportedGoal supportedGoal = default(GoalRelationshipBaseAllOfSupportedGoal))
        {
