...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StoryResponse_allOf_old_date_value")]
    public partial class StoryResponseAllOfOldDateValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoryResponseAllOfOldDateValue" /> class.
        /// </summary>
        ...
        public StoryResponseAllOfOldDateValue(DateTime? startOn = default(DateTime?), DateTime? dueAt = default(DateTime?), DateTime dueOn = default(DateTime))
        {
