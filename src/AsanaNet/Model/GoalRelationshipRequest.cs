...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GoalRelationshipRequest")]
    public partial class GoalRelationshipRequest : IValidatableObject
    {
        ...
        public GoalRelationshipRequest(GoalRelationshipCompactAllOfSupportingResource supportingResource = default(GoalRelationshipCompactAllOfSupportingResource), decimal contributionWeight = default(decimal), GoalRelationshipBaseAllOfSupportedGoal supportedGoal = default(GoalRelationshipBaseAllOfSupportedGoal))
        {
