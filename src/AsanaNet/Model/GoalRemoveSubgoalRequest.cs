...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GoalRemoveSubgoalRequest")]
    public partial class GoalRemoveSubgoalRequest : IValidatableObject
    {
        ...
        public GoalRemoveSubgoalRequest(string subgoal = default(string))
        {
            ...
            if (subgoal == null)
            {
                throw new ArgumentNullException("subgoal is a required property for GoalRemoveSubgoalRequest and cannot be null");
            }
