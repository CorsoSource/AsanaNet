...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskResponse_allOf_assignee")]
    public partial class TaskResponseAllOfAssignee : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskResponseAllOfAssignee" /> class.
        /// </summary>
        /// <param name="name">*Read-only except when same user as requester*. The user’s name..</param>
        public TaskResponseAllOfAssignee(string name = default(string))
        {
            this.Name = name;
        }
