...
namespace AsanaNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskResponse_allOf_parent")]
    public partial class TaskResponseAllOfParent : IValidatableObject
    {
        ...
        public TaskResponseAllOfParent(string name = default(string), ResourceSubtypeEnum? resourceSubtype = default(ResourceSubtypeEnum?), TaskCompactAllOfCreatedBy createdBy = default(TaskCompactAllOfCreatedBy))
        {
            this.Name = name;
