...
namespace Example
{
    public class CreateStoryForTaskExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new StoriesApi(config);
...
#### Using the CreateStoryForTaskWithHttpInfo variant
...
{
    // Create a story on a task
    ApiResponse<GetStory200Response> response = apiInstance.CreateStoryForTaskWithHttpInfo(taskGid, updateStoryRequest, optPretty, optFields);
...
{
    Debug.Print("Exception when calling StoriesApi.CreateStoryForTaskWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletestory"></a>
# **DeleteStory**
> DeleteAttachment200Response DeleteStory (string storyGid, bool? optPretty = null)
...
namespace Example
{
    public class DeleteStoryExample
    {
        public static void Main()
        {
            ...
            {
                // Delete a story
                DeleteAttachment200Response result = apiInstance.DeleteStory(storyGid, optPretty);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the DeleteStoryWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Delete a story
    ApiResponse<DeleteAttachment200Response> response = apiInstance.DeleteStoryWithHttpInfo(storyGid, optPretty);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling StoriesApi.DeleteStoryWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetStoriesForTaskExample
    {
        public static void Main()
        {
            ...
            {
                // Get stories from a task
                GetStoriesForTask200Response result = apiInstance.GetStoriesForTask(taskGid, optPretty, limit, offset, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetStoriesForTaskWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Get stories from a task
    ApiResponse<GetStoriesForTask200Response> response = apiInstance.GetStoriesForTaskWithHttpInfo(taskGid, optPretty, limit, offset, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling StoriesApi.GetStoriesForTaskWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetStoryExample
    {
        public static void Main()
        {
            ...
            {
                // Get a story
                GetStory200Response result = apiInstance.GetStory(storyGid, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetStoryWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Get a story
    ApiResponse<GetStory200Response> response = apiInstance.GetStoryWithHttpInfo(storyGid, optPretty, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling StoriesApi.GetStoryWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the UpdateStoryWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Update a story
    ApiResponse<GetStory200Response> response = apiInstance.UpdateStoryWithHttpInfo(storyGid, updateStoryRequest, optPretty, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling StoriesApi.UpdateStoryWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
