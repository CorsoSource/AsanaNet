...
# **DeleteTaskTemplate**
> DeleteAttachment200Response DeleteTaskTemplate (string taskTemplateGid, bool? optPretty = null)
...
namespace Example
{
    public class DeleteTaskTemplateExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new TaskTemplatesApi(config);
            var taskTemplateGid = 1331;  // string | Globally unique identifier for the task template.
            ...
            {
                // Delete a task template
                DeleteAttachment200Response result = apiInstance.DeleteTaskTemplate(taskTemplateGid, optPretty);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TaskTemplatesApi.DeleteTaskTemplate: " + e.Message);
...
#### Using the DeleteTaskTemplateWithHttpInfo variant
...
{
    // Delete a task template
    ApiResponse<DeleteAttachment200Response> response = apiInstance.DeleteTaskTemplateWithHttpInfo(taskTemplateGid, optPretty);
...
{
    Debug.Print("Exception when calling TaskTemplatesApi.DeleteTaskTemplateWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetTaskTemplateExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Get a task template
                GetTaskTemplate200Response result = apiInstance.GetTaskTemplate(taskTemplateGid, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TaskTemplatesApi.GetTaskTemplate: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the GetTaskTemplateWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Get a task template
    ApiResponse<GetTaskTemplate200Response> response = apiInstance.GetTaskTemplateWithHttpInfo(taskTemplateGid, optPretty, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling TaskTemplatesApi.GetTaskTemplateWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetTaskTemplatesExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var project = 321654;  // string? | The project to filter task templates on. (optional) 
            var optFields = new List<string>?(); // List<string>? | This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. (optional) 

            try
            {
                // Get multiple task templates
                GetTaskTemplates200Response result = apiInstance.GetTaskTemplates(optPretty, limit, offset, project, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TaskTemplatesApi.GetTaskTemplates: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the GetTaskTemplatesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Get multiple task templates
    ApiResponse<GetTaskTemplates200Response> response = apiInstance.GetTaskTemplatesWithHttpInfo(optPretty, limit, offset, project, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling TaskTemplatesApi.GetTaskTemplatesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class InstantiateTaskExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var optFields = new List<string>?(); // List<string>? | This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. (optional) 
            var instantiateTaskRequest = new InstantiateTaskRequest?(); // InstantiateTaskRequest? | Describes the inputs used for instantiating a task - the task's name. (optional) 

            try
            {
                // Instantiate a task from a task template
                GetJob200Response result = apiInstance.InstantiateTask(taskTemplateGid, optPretty, optFields, instantiateTaskRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TaskTemplatesApi.InstantiateTask: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the InstantiateTaskWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Instantiate a task from a task template
    ApiResponse<GetJob200Response> response = apiInstance.InstantiateTaskWithHttpInfo(taskTemplateGid, optPretty, optFields, instantiateTaskRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling TaskTemplatesApi.InstantiateTaskWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
