...
# **AddTaskForSection**
> DeleteAttachment200Response AddTaskForSection (string sectionGid, bool? optPretty = null, AddTaskForSectionRequest? addTaskForSectionRequest = null)
...
namespace Example
{
    public class AddTaskForSectionExample
    {
        public static void Main()
        {
            ...
            var addTaskForSectionRequest = new AddTaskForSectionRequest?(); // AddTaskForSectionRequest? | The task and optionally the insert location. (optional) 

            try
            {
                // Add task to section
                DeleteAttachment200Response result = apiInstance.AddTaskForSection(sectionGid, optPretty, addTaskForSectionRequest);
...
#### Using the AddTaskForSectionWithHttpInfo variant
...
{
    // Add task to section
    ApiResponse<DeleteAttachment200Response> response = apiInstance.AddTaskForSectionWithHttpInfo(sectionGid, optPretty, addTaskForSectionRequest);
...
{
    Debug.Print("Exception when calling SectionsApi.AddTaskForSectionWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class CreateSectionForProjectExample
    {
        public static void Main()
        {
            ...
            var updateSectionRequest = new UpdateSectionRequest?(); // UpdateSectionRequest? | The section to create. (optional) 

            try
            {
                // Create a section in a project
                GetSection200Response result = apiInstance.CreateSectionForProject(projectGid, optPretty, optFields, updateSectionRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the CreateSectionForProjectWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Create a section in a project
    ApiResponse<GetSection200Response> response = apiInstance.CreateSectionForProjectWithHttpInfo(projectGid, optPretty, optFields, updateSectionRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling SectionsApi.CreateSectionForProjectWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **DeleteSection**
> DeleteAttachment200Response DeleteSection (string sectionGid, bool? optPretty = null)
...
namespace Example
{
    public class DeleteSectionExample
    {
        public static void Main()
        {
            ...
            {
                // Delete a section
                DeleteAttachment200Response result = apiInstance.DeleteSection(sectionGid, optPretty);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Delete a section
    ApiResponse<DeleteAttachment200Response> response = apiInstance.DeleteSectionWithHttpInfo(sectionGid, optPretty);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Get a section
    ApiResponse<GetSection200Response> response = apiInstance.GetSectionWithHttpInfo(sectionGid, optPretty, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class GetSectionsForProjectExample
    {
        public static void Main()
        {
            ...
            {
                // Get sections in a project
                GetSectionsForProject200Response result = apiInstance.GetSectionsForProject(projectGid, optPretty, limit, offset, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetSectionsForProjectWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Get sections in a project
    ApiResponse<GetSectionsForProject200Response> response = apiInstance.GetSectionsForProjectWithHttpInfo(projectGid, optPretty, limit, offset, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling SectionsApi.GetSectionsForProjectWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> DeleteAttachment200Response InsertSectionForProject (string projectGid, bool? optPretty = null, InsertSectionForProjectRequest? insertSectionForProjectRequest = null)
...
namespace Example
{
    public class InsertSectionForProjectExample
    {
        public static void Main()
        {
            ...
            var projectGid = 1331;  // string | Globally unique identifier for the project.
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var insertSectionForProjectRequest = new InsertSectionForProjectRequest?(); // InsertSectionForProjectRequest? | The section's move action. (optional) 

            try
            {
                // Move or Insert sections
                DeleteAttachment200Response result = apiInstance.InsertSectionForProject(projectGid, optPretty, insertSectionForProjectRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the InsertSectionForProjectWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Move or Insert sections
    ApiResponse<DeleteAttachment200Response> response = apiInstance.InsertSectionForProjectWithHttpInfo(projectGid, optPretty, insertSectionForProjectRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling SectionsApi.InsertSectionForProjectWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class UpdateSectionExample
    {
        public static void Main()
        {
            ...
            {
                // Update a section
                GetSection200Response result = apiInstance.UpdateSection(sectionGid, optPretty, optFields, updateSectionRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Update a section
    ApiResponse<GetSection200Response> response = apiInstance.UpdateSectionWithHttpInfo(sectionGid, optPretty, optFields, updateSectionRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
