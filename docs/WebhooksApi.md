...
{
    // Establish a webhook
    ApiResponse<CreateWebhook201Response> response = apiInstance.CreateWebhookWithHttpInfo(createWebhookRequest, optPretty, optFields);
...
# **DeleteWebhook**
> DeleteAttachment200Response DeleteWebhook (string webhookGid, bool? optPretty = null)
...
namespace Example
{
    public class DeleteWebhookExample
    {
        public static void Main()
        {
            ...
            {
                // Delete a webhook
                DeleteAttachment200Response result = apiInstance.DeleteWebhook(webhookGid, optPretty);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Delete a webhook
    ApiResponse<DeleteAttachment200Response> response = apiInstance.DeleteWebhookWithHttpInfo(webhookGid, optPretty);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Get a webhook
    ApiResponse<CreateWebhook201Response> response = apiInstance.GetWebhookWithHttpInfo(webhookGid, optPretty, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class GetWebhooksExample
    {
        public static void Main()
        {
            ...
            {
                // Get multiple webhooks
                GetWebhooks200Response result = apiInstance.GetWebhooks(workspace, optPretty, limit, offset, resource, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Get multiple webhooks
    ApiResponse<GetWebhooks200Response> response = apiInstance.GetWebhooksWithHttpInfo(workspace, optPretty, limit, offset, resource, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    // Update a webhook
    ApiResponse<CreateWebhook201Response> response = apiInstance.UpdateWebhookWithHttpInfo(webhookGid, updateWebhookRequest, optPretty, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
