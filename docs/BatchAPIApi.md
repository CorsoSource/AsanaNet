...
namespace Example
{
    public class CreateBatchRequestExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new BatchAPIApi(config);
...
#### Using the CreateBatchRequestWithHttpInfo variant
...
{
    // Submit parallel requests
    ApiResponse<CreateBatchRequest200Response> response = apiInstance.CreateBatchRequestWithHttpInfo(createBatchRequestRequest, optPretty, optFields);
...
{
    Debug.Print("Exception when calling BatchAPIApi.CreateBatchRequestWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
