# AsanaNet.Api.CustomFieldSettingsApi
...
namespace Example
{
    public class GetCustomFieldSettingsForPortfolioExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new CustomFieldSettingsApi(config);
            ...
            {
                // Get a portfolio's custom fields
                GetCustomFieldSettingsForProject200Response result = apiInstance.GetCustomFieldSettingsForPortfolio(portfolioGid, optPretty, limit, offset, optFields);
...
#### Using the GetCustomFieldSettingsForPortfolioWithHttpInfo variant
...
{
    // Get a portfolio's custom fields
    ApiResponse<GetCustomFieldSettingsForProject200Response> response = apiInstance.GetCustomFieldSettingsForPortfolioWithHttpInfo(portfolioGid, optPretty, limit, offset, optFields);
...
{
    Debug.Print("Exception when calling CustomFieldSettingsApi.GetCustomFieldSettingsForPortfolioWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetCustomFieldSettingsForProjectExample
    {
        public static void Main()
        {
            ...
            {
                // Get a project's custom fields
                GetCustomFieldSettingsForProject200Response result = apiInstance.GetCustomFieldSettingsForProject(projectGid, optPretty, limit, offset, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetCustomFieldSettingsForProjectWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Get a project's custom fields
    ApiResponse<GetCustomFieldSettingsForProject200Response> response = apiInstance.GetCustomFieldSettingsForProjectWithHttpInfo(projectGid, optPretty, limit, offset, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling CustomFieldSettingsApi.GetCustomFieldSettingsForProjectWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
