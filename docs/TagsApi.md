...
{
    // Create a tag
    ApiResponse<CreateTag201Response> response = apiInstance.CreateTagWithHttpInfo(createTagRequest, optPretty, optFields);
...
namespace Example
{
    public class CreateTagForWorkspaceExample
    {
        public static void Main()
        {
            ...
            var createTagForWorkspaceRequest = new CreateTagForWorkspaceRequest(); // CreateTagForWorkspaceRequest | The tag to create.
            var optPretty = true;  // bool? | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging. (optional) 
            var optFields = new List<string>?(); // List<string>? | This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. (optional) 
            ...
            {
                // Create a tag in a workspace
                CreateTag201Response result = apiInstance.CreateTagForWorkspace(workspaceGid, createTagForWorkspaceRequest, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the CreateTagForWorkspaceWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Create a tag in a workspace
    ApiResponse<CreateTag201Response> response = apiInstance.CreateTagForWorkspaceWithHttpInfo(workspaceGid, createTagForWorkspaceRequest, optPretty, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling TagsApi.CreateTagForWorkspaceWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deletetag"></a>
# **DeleteTag**
> DeleteAttachment200Response DeleteTag (string tagGid, bool? optPretty = null)
...
namespace Example
{
    public class DeleteTagExample
    {
        public static void Main()
        {
            ...
            {
                // Delete a tag
                DeleteAttachment200Response result = apiInstance.DeleteTag(tagGid, optPretty);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Delete a tag
    ApiResponse<DeleteAttachment200Response> response = apiInstance.DeleteTagWithHttpInfo(tagGid, optPretty);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class GetTagExample
    {
        public static void Main()
        {
            ...
            {
                // Get a tag
                CreateTag201Response result = apiInstance.GetTag(tagGid, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Get a tag
    ApiResponse<CreateTag201Response> response = apiInstance.GetTagWithHttpInfo(tagGid, optPretty, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class GetTagsExample
    {
        public static void Main()
        {
            ...
            {
                // Get multiple tags
                GetTags200Response result = apiInstance.GetTags(optPretty, limit, offset, workspace, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Get multiple tags
    ApiResponse<GetTags200Response> response = apiInstance.GetTagsWithHttpInfo(optPretty, limit, offset, workspace, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class GetTagsForTaskExample
    {
        public static void Main()
        {
            ...
            {
                // Get a task's tags
                GetTags200Response result = apiInstance.GetTagsForTask(taskGid, optPretty, limit, offset, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetTagsForTaskWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Get a task's tags
    ApiResponse<GetTags200Response> response = apiInstance.GetTagsForTaskWithHttpInfo(taskGid, optPretty, limit, offset, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling TagsApi.GetTagsForTaskWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetTagsForWorkspaceExample
    {
        public static void Main()
        {
            ...
            {
                // Get tags in a workspace
                GetTags200Response result = apiInstance.GetTagsForWorkspace(workspaceGid, optPretty, limit, offset, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetTagsForWorkspaceWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Get tags in a workspace
    ApiResponse<GetTags200Response> response = apiInstance.GetTagsForWorkspaceWithHttpInfo(workspaceGid, optPretty, limit, offset, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling TagsApi.GetTagsForWorkspaceWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="updatetag"></a>
# **UpdateTag**
> CreateTag201Response UpdateTag (string tagGid, bool? optPretty = null, List<string>? optFields = null)
...
namespace Example
{
    public class UpdateTagExample
    {
        public static void Main()
        {
            ...
            {
                // Update a tag
                CreateTag201Response result = apiInstance.UpdateTag(tagGid, optPretty, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Update a tag
    ApiResponse<CreateTag201Response> response = apiInstance.UpdateTagWithHttpInfo(tagGid, optPretty, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
