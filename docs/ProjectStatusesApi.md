# AsanaNet.Api.ProjectStatusesApi
...
namespace Example
{
    public class CreateProjectStatusForProjectExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ProjectStatusesApi(config);
...
#### Using the CreateProjectStatusForProjectWithHttpInfo variant
...
{
    // Create a project status
    ApiResponse<GetProjectStatus200Response> response = apiInstance.CreateProjectStatusForProjectWithHttpInfo(projectGid, createProjectStatusForProjectRequest, optPretty, optFields);
...
{
    Debug.Print("Exception when calling ProjectStatusesApi.CreateProjectStatusForProjectWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **DeleteProjectStatus**
> DeleteAttachment200Response DeleteProjectStatus (string projectStatusGid, bool? optPretty = null)
...
namespace Example
{
    public class DeleteProjectStatusExample
    {
        public static void Main()
        {
            ...
            {
                // Delete a project status
                DeleteAttachment200Response result = apiInstance.DeleteProjectStatus(projectStatusGid, optPretty);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the DeleteProjectStatusWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Delete a project status
    ApiResponse<DeleteAttachment200Response> response = apiInstance.DeleteProjectStatusWithHttpInfo(projectStatusGid, optPretty);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ProjectStatusesApi.DeleteProjectStatusWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
#### Using the GetProjectStatusWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Get a project status
    ApiResponse<GetProjectStatus200Response> response = apiInstance.GetProjectStatusWithHttpInfo(projectStatusGid, optPretty, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ProjectStatusesApi.GetProjectStatusWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetProjectStatusesForProjectExample
    {
        public static void Main()
        {
            ...
            {
                // Get statuses from a project
                GetProjectStatusesForProject200Response result = apiInstance.GetProjectStatusesForProject(projectGid, optPretty, limit, offset, optFields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
#### Using the GetProjectStatusesForProjectWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Get statuses from a project
    ApiResponse<GetProjectStatusesForProject200Response> response = apiInstance.GetProjectStatusesForProjectWithHttpInfo(projectGid, optPretty, limit, offset, optFields);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ProjectStatusesApi.GetProjectStatusesForProjectWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
